  ...
  return (
    <div name='hero' className='w-full h-screen bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col h-full justify-center'>
        ...
        <div>
          <button className='border-2 group text-white px-6 py-2 flex items-center my-2 hover:bg-pink-600 hover:border-pink-600'><Link to="work" smooth={true} duration={500}>View Works</Link><span className='group-hover:rotate-90 duration-300'><Link to='work' smooth={true} duration={500}><HiArrowNarrowRight className='ml-3' /></Link></span></button>
        </div>
